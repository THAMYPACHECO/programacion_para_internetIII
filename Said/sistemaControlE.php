...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
        ...
        if ($peso > 5000) {
            $mensaje  = "<strong>Alerta:</strong> El camion requiere un pago de impuesto por sobrepeso.";
            $claseCss = "alerta";
        } else {
            $mensaje  = "<strong>Transito autorizado:</strong> Peso dentro del limite legal.";
            $claseCss = "autorizado";
        }
    ?>
        ...
        <ul>
            ...
            <li><strong>Código del Camion:</strong> <?php echo $camion; ?></li>
            <li><strong>Peso de la Carga:</strong> <?php echo number_format($peso, 2); ?> kg</li>
        </ul>
    <?php } ?>
